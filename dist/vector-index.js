...
export class VectorIndex {
    ...
    openSearcher(identity = identityOf(this.indexPath)) {
    ...
    refresh() {
        ...
        if (current === null || sameFile(current, this.opened) || sameFile(current, this.rejected))
            return;
        try {
            ...
            process.stderr.write(`starmemory: ${this.indexPath} was replaced but cannot be opened (${reason}); still using the previous index\n`);
        }
    }
